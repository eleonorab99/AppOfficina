                ...
                <div className="max-w-3xl mx-auto px-2 md:px-4 mt-8">
                    ...
                    <ul className="list-none space-y-2 text-gray-700 text-sm md:text-base">
                        <li className="flex items-start">
                            ...
                            Riparazione impianto elettrico e diagnostica avanzata.
                        </li>
                        <li className="flex items-start">
                            <span className="text-blue-700 mr-2 mt-1">✔</span>
                            Sostituzione batterie, alternatori e motorini di avviamento.
                        </li>
                        <li className="flex items-start">
                            <span className="text-blue-700 mr-2 mt-1">✔</span>
                            Riparazione centraline e sistemi di controllo.
                        </li>
                    </ul>
                </div>
            </div>
